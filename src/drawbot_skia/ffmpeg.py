...
def generateMP4(
    imageTemplate, mp4path, frameRate, codec="libx264", preferPyFFmpeg=False
):
    ...
    cmds = [
        ...
        "-pix_fmt",
        "yuv420p10le",  # pixel format. 8bit: yuv420p 10bit: yuv420p10le, yuv422p10le, yuv444p10le
        mp4path,  # output path
    ]
...
def getPyFFmpegPath():
    try:
        ...
        raise ImportError(
            "ffmpeg not found: install ffmpeg manually, or do 'pip install pyffmpeg==1.6.1'"
        )
